...
const DID_YOU_MEAN = {
	...
	chunkfilename: "output.chunkFilename or entry.*.chunkFilename",
	initialchunkfilename:
		"output.initialChunkFilename or entry.*.initialChunkFilename",
	ecmaversion:
				...
				if (error.keyword === "additionalProperties") {
					...
					if (
						Object.prototype.hasOwnProperty.call(
							DID_YOU_MEAN,
							params.additionalProperty.toLowerCase()
						)
					) {
						return `${formattedError}\nDid you mean ${
							DID_YOU_MEAN[params.additionalProperty.toLowerCase()]
						}?`;
					}

...
/** @typedef {import("../../declarations/WebpackOptions").EntryDescriptionOptions} EntryDescriptionOptions */
...
const applyOutputDefaults = (
	...
	F(output, "initialChunkFilename", () => output.filename);
	...
	/**
	 * @param {function(EntryDescriptionOptions): void} fn iterator
	 * @returns {void}
	 */

...
class Chunk {
	 ...
	 */
	constructor(name, options = EMPTY_CHUNK_OPTIONS) {
	 ...
	 */
	hasRuntime() {
		return this._groups.getFromUnorderedCache(this._hasRuntime);
	}
	 ...
	 */
	getEntryOptions() {
		return this._groups.getFromUnorderedCache(getEntryOptions);
	}
